gap> START_TEST("Formspace: Preserved Formspace GP22");
gap> G := GP22;; # Some groups are defined in interesting_groups.g
gap> R := PseudoRandom(GL(3, GF(7^2)));;
gap> G := G^R;;
...
true
gap> STOP_TEST("Formspace: Preserved Formspace GP22");
