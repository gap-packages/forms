gap> START_TEST("Formspace: Preserved Formspace Gtriv");
gap> G := Gtriv;; # Some groups are defined in interesting_groups.g
gap> R := PseudoRandom(GL(10, GF(5)));;
gap> G := G^R;;
gap> f_space_expected_normal_d := 100;; # the dimensions of the expected formspaces 
...
true
gap> STOP_TEST("Formspace: Preserved Formspace Gtriv");
