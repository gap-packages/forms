...
__FORMSPACE__INTERNAL__EvaluatePolynomialWithFrobenius := function(p, g, frob_base, frob_base_inv, F, n)
...
# find symplectic and symmetric forms this is probably terrible code.
...
#! @Arguments G Matrix Group, Lambdas Scalars, unitary Boolean (look for unitary forms/bilinear forms)
#! @Returns The space of preserved forms modulo Lambda
#! @Description
#!  Todo
...
#! @Arguments G Matrix Group
#! @Returns The space of preserved forms (does assume all scalars = 1) (both unitary and bilinear)
#! @Description
#!  Todo
InstallMethod(PreservedFormspace,
